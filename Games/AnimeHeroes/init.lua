...
do
	...
	local t1 = task.defer(function()
		while task.wait() do
			...
			char.Humanoid.WalkSpeed = getgenv().CXT.WalkSpeed
		end
	end)
...
local Tabs = {
	...
	AutoMain = Window:AddTab({ Title = "Auto Main", Icon = "shield" }),
...
-- AutoFarmSelected
do
	local Toggle = Tabs.AutoFarm:AddToggle("AutoFarmSelected", { Title = "Auto Farm Selected", Default = false })
...
do
	...
	local Dropdown2 = Tabs.AutoFarm:AddDropdown("AutoFarmEnemies", {
